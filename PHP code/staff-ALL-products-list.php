...
echo "<div id='product-grid'>";
    global $wpdb;
	$product_array = $wpdb->get_results("SELECT productID, productName, productImage, productQty, FORMAT(productPrice, 2) AS productPrice 
                                         FROM product");
            ...
            "<div class='product-item'>
                <form method='GET'>
                    <div class='product-image'>
                        <a href='https://limchiachung.azurewebsites.net/product-description/?productID=$key->productID' name='productDetails'>
                    ...
                    <div class='product-tile-footer'>
                        ...
                        <div class='cart-action'>
                            <a href='https://limchiachung.azurewebsites.net/product-description/?productID=$key->productID' name='link_product'>
                                <input type='button' name='productDetails' value='Product Details' id='productDetailsButtton'/>
                            </a>
                        </div>
                    </div>
                </form>
